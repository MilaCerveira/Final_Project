...
public class DataLoader  implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Question spquestion3 = new Question("What is the Spanish word for 'exit'?", "Spanish");
        ...
        questionRepository.save(spquestion5);
        ...
        answerRepository.save(spq6answer1);
        answerRepository.save(spq6answer2);
        answerRepository.save(spq6answer3);
        answerRepository.save(spq6answer4);
        ...
        answerRepository.save(frq2answer1);
        answerRepository.save(frq2answer2);
        answerRepository.save(frq2answer3);
        answerRepository.save(frq2answer4);
        ...
        Answer frq6answer1 = new Answer("A strike", true, "That's right!", frquestion6);
        Answer frq6answer2 = new Answer("A bowl", false, "No, it means a strike", frquestion6);
        Answer frq6answer3 = new Answer("A coat", false, "No, it means a strike", frquestion6);
        Answer frq6answer4 = new Answer("A pill", false, "No, it means a strike", frquestion6);
...
//
        ...
        Question dequestion3 = new Question("test Q 3", "German");
        questionRepository.save(dequestion3);

        Answer deq3answer1= new Answer("test", false, "test", dequestion3);
        Answer deq3answer2 = new Answer("test", true, "test", dequestion3);
        Answer deq3answer3 = new Answer("test", false, "test", dequestion3);
        Answer deq3answer4 = new Answer("test", false, "test", dequestion3);
        answerRepository.save(deq3answer1);
        answerRepository.save(deq3answer2);
        answerRepository.save(deq3answer3);
        answerRepository.save(deq3answer4);


        Question dequestion4 = new Question("test Q 4", "German");
        questionRepository.save(dequestion4);

        Answer deq4answer1 = new Answer("test", false, "test", dequestion4);
        Answer deq4answer2 = new Answer("test", true, "test", dequestion4);
        Answer deq4answer3 = new Answer("test", false, "test", dequestion4);
        Answer deq4answer4 = new Answer("test", false, "test", dequestion4);
        answerRepository.save(deq4answer1);
        answerRepository.save(deq4answer2);
        answerRepository.save(deq4answer3);
        answerRepository.save(deq4answer4);

        Question dequestion5 = new Question("test Q 5", "German");
        questionRepository.save(dequestion5);

        Answer deq5answer1 = new Answer("test", false, "test", dequestion5);
        Answer deq5answer2 = new Answer("test", true, "test", dequestion5);
        Answer deq5answer3 = new Answer("test", false, "test", dequestion5);
        Answer deq5answer4 = new Answer("test", false, "test", dequestion5);
        answerRepository.save(deq5answer1);
        answerRepository.save(deq5answer2);
        answerRepository.save(deq5answer3);
        answerRepository.save(deq5answer4);


        Question dequestion6 = new Question("test Q 6", "German");
        questionRepository.save(dequestion6);

        Answer deq6answer1 = new Answer("test", false, "test", dequestion6);
        Answer deq6answer2 = new Answer("test", true, "test", dequestion6);
        Answer deq6answer3 = new Answer("test", false, "test", dequestion6);
        Answer deq6answer4 = new Answer("test", false, "test", dequestion6);
        answerRepository.save(deq6answer1);
        answerRepository.save(deq6answer2);
        answerRepository.save(deq6answer3);
        ...
        Answer roq1answer1 = new Answer("test", false, "test", roquestion1);
        Answer roq1answer2 = new Answer("test", true, "test", roquestion1);
        Answer roq1answer3 = new Answer("test", false, "test", roquestion1);
        Answer roq1answer4 = new Answer("test", false, "test", roquestion1);
        answerRepository.save(roq1answer1);
        answerRepository.save(roq1answer2);
        answerRepository.save(roq1answer3);
        answerRepository.save(roq1answer4);


        Question roquestion2 = new Question("test Q 2", "Romanian");
        questionRepository.save(roquestion2);

        Answer roq2answer1 = new Answer("test", false, "test", roquestion2);
        Answer roq2answer2 = new Answer("test", true, "test", roquestion2);
        Answer roq2answer3 = new Answer("test", false, "test", roquestion2);
        Answer roq2answer4 = new Answer("test", false, "test", roquestion2);
        answerRepository.save(roq2answer1);
        answerRepository.save(roq2answer2);
        answerRepository.save(roq2answer3);
        answerRepository.save(roq2answer4);


        Question roquestion3 = new Question("test Q 3", "Romanian");
        questionRepository.save(roquestion3);

        Answer roq3answer1= new Answer("test", false, "test", roquestion3);
        Answer roq3answer2 = new Answer("test", true, "test", roquestion3);
        Answer roq3answer3 = new Answer("test", false, "test", roquestion3);
        Answer roq3answer4 = new Answer("test", false, "test", roquestion3);
        answerRepository.save(roq3answer1);
        answerRepository.save(roq3answer2);
        answerRepository.save(roq3answer3);
        answerRepository.save(roq3answer4);


        Question roquestion4 = new Question("test Q 4", "Romanian");
        questionRepository.save(roquestion4);

        Answer roq4answer1 = new Answer("test", false, "test", roquestion4);
        Answer roq4answer2 = new Answer("test", true, "test", roquestion4);
        Answer roq4answer3 = new Answer("test", false, "test", roquestion4);
        Answer roq4answer4 = new Answer("test", false, "test", roquestion4);
        answerRepository.save(roq4answer1);
        answerRepository.save(roq4answer2);
        answerRepository.save(roq4answer3);
        answerRepository.save(roq4answer4);

        Question roquestion5 = new Question("test Q 5", "Romanian");
        questionRepository.save(roquestion5);

        Answer roq5answer1 = new Answer("test", false, "test", roquestion5);
        Answer roq5answer2 = new Answer("test", true, "test", roquestion5);
        Answer roq5answer3 = new Answer("test", false, "test", roquestion5);
        Answer roq5answer4 = new Answer("test", false, "test", roquestion5);
        answerRepository.save(roq5answer1);
        answerRepository.save(roq5answer2);
        answerRepository.save(roq5answer3);
        answerRepository.save(roq5answer4);


        Question roquestion6 = new Question("test Q 6", "Romanian");
        questionRepository.save(roquestion6);

        Answer roq6answer1 = new Answer("test", false, "test", roquestion6);
        Answer roq6answer2 = new Answer("test", true, "test", roquestion6);
        Answer roq6answer3 = new Answer("test", false, "test", roquestion6);
        Answer roq6answer4 = new Answer("test", false, "test", roquestion6);
        answerRepository.save(roq6answer1);
        answerRepository.save(roq6answer2);
